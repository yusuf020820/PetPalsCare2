...
const posts = [
  {
    ...
    author: {
      imageUrl:
        "https://drive.google.com/uc?id=1oonn5IChr3VGrSBLD2Pg853o18FPEvbu", // Ganti dengan URL gambar yang benar
    },
  },
  // More posts...
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-1">
          {posts.map((post) => (
            <article
              key={post.id}
              className="flex flex-col items-start justify-between bg-white shadow-lg rounded-lg p-6 w-full"
            >
              <div className="flex flex-col sm:flex-row sm:items-start sm:gap-x-6 mt-3 w-full">
                ...
                <div className="flex flex-col mt-3 sm:mt-0 w-full">
                  ...
                  <p className="mt-5 text-sm leading-6 text-gray-600">
                    ...
                    7 Tahun <br />
                    <span style={{ color: "#564741" }}>
                      <strong>Spesialis Hewan:</strong>
                    </span>{" "}
                    Hewan Domestik dan Eksotik
                  </p>
