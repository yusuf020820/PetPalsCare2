...
const posts = [
  {
    id: 1,
    content: 'Welcome to PetPals Care!<br />Hello <strong>Destya Vinka!</strong> <strong>drs. Muhammad Ali</strong> will be here with you shortly.<br />Please describe your medical condition',
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center justify-between bg-white p-4 shadow-md">
        <div className="flex items-center space-x-4">
          <div className="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center">
            <img src="src/assets/images/DokterCowo.png" alt="Doctor Avatar" className="w-full h-full rounded-full object-cover" />
          </div>
          <div>
      ...
      <div className="mx-auto max-w-2xl mt-10 p-4 space-y-4">
        {posts.map((post) => (
          <div key={post.id} className={`p-4 ${post.bgColor} ${post.height} ${post.maxWidth} ${post.id === 3 ? post.marginLeft : ''} rounded-lg shadow-sm`}>
